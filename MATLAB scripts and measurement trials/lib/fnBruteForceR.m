...
errBest = 1e6; uBest = [1 1 1]/sqrt(3); phiBest = 0; % zacetni best case scenario

for phi = 0:0.05:5 % bilo prej phi = -5:0.05:5
    for ux = -1:0.05:1 % bilo prej ux = 0:0.05:1
        for uy = -1:0.05:1  % bilo prej uy = 0:0.2:1
            for uz = -1:0.05:1  % bilo prej uz = 0:0.2:1
...
disp('The connecting rotation matrix is:')
disp(R0)
